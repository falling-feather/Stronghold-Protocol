...
// 地图库：包含多个不同的地图配置
// 注意：所有路径点必须在地面上（TileType 0），不能在高台上（TileType 1）
export const MAP_LIBRARY: Array<{ layout: TileType[][], waypoints: Vector2[] }> = [
  // 地图1：原始地图（修复路径）
  {
    layout: [
      [2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
    ...
    waypoints: [
      { x: 0, y: 1 }, { x: 3, y: 1 }, { x: 3, y: 3 }, { x: 3, y: 4 }, { x: 7, y: 4 },
      { x: 7, y: 5 }, { x: 5, y: 5 }, { x: 5, y: 6 }, { x: 5, y: 7 },
    ]
  },
  // 地图2：直线路径（修复路径）
  {
    ...
    waypoints: [
      { x: 0, y: 1 }, { x: 8, y: 1 }, { x: 1, y: 3 }, { x: 8, y: 3 },
  ...
  // 地图3：S形路径（修复路径）
  {
    ...
    waypoints: [
      { x: 0, y: 1 }, { x: 4, y: 1 }, { x: 8, y: 2 }, { x: 1, y: 3 },
      { x: 4, y: 3 }, { x: 4, y: 4 }, { x: 5, y: 4 }, { x: 7, y: 5 },
      { x: 7, y: 7 },
    ]
  },
  // 地图4：中心广场（修复路径）
  {
    ...
    waypoints: [
      { x: 0, y: 1 }, { x: 2, y: 1 }, { x: 2, y: 3 }, { x: 7, y: 3 },
      { x: 7, y: 5 }, { x: 2, y: 5 }, { x: 2, y: 6 }, { x: 8, y: 6 },
    ]
  },
  // 地图5：Z形路径（修复路径）
  {
    ...
    waypoints: [
      { x: 0, y: 1 }, { x: 8, y: 1 }, { x: 1, y: 4 }, { x: 8, y: 4 },
      { x: 8, y: 7 },
    ]
  },
  // 地图6：复杂路径（修复路径）
  {
    ...
    waypoints: [
      { x: 0, y: 1 }, { x: 3, y: 1 }, { x: 3, y: 2 }, { x: 3, y: 4 },
      { x: 7, y: 4 }, { x: 7, y: 5 }, { x: 1, y: 5 }, { x: 1, y: 6 },
      { x: 5, y: 6 }, { x: 5, y: 7 }, { x: 8, y: 7 },
    ]
  }
];
