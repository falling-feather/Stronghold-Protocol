...
export const RESONANCE_DB: Record<string, PactResonance> = {
  ...
  reso_wind_blade: {
    id: 'reso_wind_blade',
    name: '共鸣·风刃',
    desc: '碎铳之簧 + 空中猎手 同时达 tier1：全体攻速 +8%',
    requires: [
  ...
  // v3.12.0：补齐 7C2=21 共鸣全覆盖（剩余 9 对）
  reso_break_flame: {
    id: 'reso_break_flame',
    name: '共鸣·烈破',
    desc: '破甲誓约 + 炎佑 同时达 tier1：全体攻击 +5%',
    requires: [
      { defId: 'pact_shield_breaker', minTier: 0 },
      { defId: 'pact_flame_blessing', minTier: 0 },
    ],
    scope: 'all_operators',
    effects: [mkResoEffect('resonance_reso_break_flame_atk', '[共鸣·烈破] 焰破之刃', 'atk', 0.05, 'pct')],
    shackledBoosts: true,
  },
  reso_break_echo: {
    id: 'reso_break_echo',
    name: '共鸣·破响',
    desc: '破甲誓约 + 余音回响 同时达 tier1：全体攻击 +4',
    requires: [
      { defId: 'pact_shield_breaker', minTier: 0 },
      { defId: 'pact_lingering_echo', minTier: 0 },
    ],
    scope: 'all_operators',
    effects: [mkResoEffect('resonance_reso_break_echo_atk', '[共鸣·破响] 破甲余响', 'atk', 4, 'flat')],
    shackledBoosts: true,
  },
  reso_break_spring: {
    id: 'reso_break_spring',
    name: '共鸣·裂簧',
    desc: '破甲誓约 + 碎铳之簧 同时达 tier1：全体攻速 +4%',
    requires: [
      { defId: 'pact_shield_breaker', minTier: 0 },
      { defId: 'pact_broken_spring', minTier: 0 },
    ],
    scope: 'all_operators',
    effects: [mkResoEffect('resonance_reso_break_spring_aspd', '[共鸣·裂簧] 裂簧之击', 'aspd', -0.04, 'pct')],
    shackledBoosts: true,
  },
  reso_break_aerial: {
    id: 'reso_break_aerial',
    name: '共鸣·破翼',
    desc: '破甲誓约 + 空中猎手 同时达 tier1：全体攻击 +6',
    requires: [
      { defId: 'pact_shield_breaker', minTier: 0 },
      { defId: 'pact_aerial_hunter', minTier: 0 },
    ],
    scope: 'all_operators',
    effects: [mkResoEffect('resonance_reso_break_aerial_atk', '[共鸣·破翼] 穿空之锋', 'atk', 6, 'flat')],
    shackledBoosts: true,
  },
  reso_break_hunt: {
    id: 'reso_break_hunt',
    name: '共鸣·猎破',
    desc: '破甲誓约 + 狩猎之心 同时达 tier1：全体攻击 +5%',
    requires: [
      { defId: 'pact_shield_breaker', minTier: 0 },
      { defId: 'pact_hunt_enrage', minTier: 0 },
    ],
    scope: 'all_operators',
    effects: [mkResoEffect('resonance_reso_break_hunt_atk', '[共鸣·猎破] 猎破之誓', 'atk', 0.05, 'pct')],
    shackledBoosts: true,
  },
  reso_hunt_flame: {
    id: 'reso_hunt_flame',
    name: '共鸣·烈狩',
    desc: '狩猎之心 + 炎佑 同时达 tier1：全体移动速度 +3%',
    requires: [
      { defId: 'pact_hunt_enrage', minTier: 0 },
      { defId: 'pact_flame_blessing', minTier: 0 },
    ],
    scope: 'all_operators',
    effects: [mkResoEffect('resonance_reso_hunt_flame_spd', '[共鸣·烈狩] 焰猎之疾', 'spd', 0.03, 'pct')],
    shackledBoosts: true,
  },
  reso_hunt_echo: {
    id: 'reso_hunt_echo',
    name: '共鸣·余狩',
    desc: '狩猎之心 + 余音回响 同时达 tier1：全体魔抗 +4',
    requires: [
      { defId: 'pact_hunt_enrage', minTier: 0 },
      { defId: 'pact_lingering_echo', minTier: 0 },
    ],
    scope: 'all_operators',
    effects: [mkResoEffect('resonance_reso_hunt_echo_mr', '[共鸣·余狩] 余响猎心', 'magicResist', 4, 'flat')],
    shackledBoosts: true,
  },
  reso_hunt_spring: {
    id: 'reso_hunt_spring',
    name: '共鸣·簧狩',
    desc: '狩猎之心 + 碎铳之簧 同时达 tier1：全体攻速 +4%',
    requires: [
      { defId: 'pact_hunt_enrage', minTier: 0 },
      { defId: 'pact_broken_spring', minTier: 0 },
    ],
    scope: 'all_operators',
    effects: [mkResoEffect('resonance_reso_hunt_spring_aspd', '[共鸣·簧狩] 簧鸣猎风', 'aspd', -0.04, 'pct')],
    shackledBoosts: true,
  },
  reso_hunt_iron: {
    id: 'reso_hunt_iron',
    name: '共鸣·铁狩',
    desc: '狩猎之心 + 钢铁誓约 同时达 tier1：全体防御 +3',
    requires: [
      { defId: 'pact_hunt_enrage', minTier: 0 },
      { defId: 'pact_iron_resolve', minTier: 0 },
    ],
    scope: 'all_operators',
    effects: [mkResoEffect('resonance_reso_hunt_iron_def', '[共鸣·铁狩] 铁血猎志', 'def', 3, 'flat')],
    shackledBoosts: true,
  },
};
