...
export function showOnly(targetId: string, displayMode: string = 'flex'): void {
  const ids = ['start-screen', 'faction-screen', 'roster-screen', 'mp-screen', 'pact-screen', 'meta-screen', 'boon-screen', 'achievement-screen', 'daily-screen', 'settings-screen', 'app-root'];
  ids.forEach(id => {
